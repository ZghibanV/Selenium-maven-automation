...
public class PersonalInfoTest {
	...
	public void navigateToHomePage() {
		...
		dateOfBirth = data.date().birthday().toString().replaceAll(",", "");
		email = "zghibanvasile@gmail.com";
	...
	public void submitFullApplication() {
		...
		driver.findElement(By.xpath("(//input[@type='checkbox'])["+ data.number().numberBetween(1, 4) + "]")).click();
	}
